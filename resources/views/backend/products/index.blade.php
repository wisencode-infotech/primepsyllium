    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-surface-elevated shadow sm:rounded-lg overflow-hidden">
                <p class="px-4 sm:px-8 pt-4 sm:pt-6 text-sm text-text-muted">
                    Drag rows by the handle to change the order products appear in on the homepage.
                </p>
                    ...
                    <table class="w-full mt-4 min-w-[640px]">
                        <thead>
                            <tr class="text-left text-xs font-semibold text-text-muted uppercase tracking-wider border-b border-border">
                                ...
                                <th class="px-2 py-2 w-20">Image</th>
                        ...
                        <tbody id="product-rows">
                            @forelse ($products as $product)
                                <tr draggable="true" data-id="{{ $product->id }}" class="border-b border-border last:border-b-0 cursor-move hover:bg-surface-muted">
                                    ...
                                    <td class="px-2 py-3 text-right sm:pr-8">
                                        <div class="flex items-center justify-end gap-3">
                                            <a href="{{ route('admin.products.edit', $product) }}" class="text-sm text-primary hover:text-primary-hover">Edit</a>
