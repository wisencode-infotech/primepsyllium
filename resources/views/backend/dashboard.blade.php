<x-backend-layout>
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="rounded-2xl bg-primary px-6 py-8 text-white sm:px-10">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <a href="{{ route('admin.products.index') }}" class="group flex items-center gap-4 rounded-xl border border-border bg-surface-elevated p-5 transition hover:border-primary">
            ...
            <a href="{{ route('admin.certifications.index') }}" class="group flex items-center gap-4 rounded-xl border border-border bg-surface-elevated p-5 transition hover:border-primary">
                <span class="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-primary-soft text-primary">
