...
return [
    ...
    */
    'items' => [
        ...
        [
            'id'          => 6,
            'name'        => 'Psyllium Splits',
            'slug'        => 'psyllium-splits',
            'description' => 'Dehusked psyllium split for targeted processing and formulation',
            'categories'  => ['splits', 'granules'],
            'image'       => 'assets/frontend/images/products/psyllium-splits.png',
        ],
        [
            'id'          => 7,
            'name'        => 'Psyllium Fiber',
            'slug'        => 'psyllium-fiber',
            'description' => 'Concentrated soluble fiber for supplement and health formulations',
            'categories'  => ['fibers'],
            'image'       => 'assets/frontend/images/products/psyllium-fiber.png',
        ],
        [
            'id'          => 8,
            'name'        => 'Psyllium Meal',
            'slug'        => 'psyllium-meal',
            'description' => 'Nutritious meal from psyllium processing for feed and food use',
            'categories'  => ['meal'],
            'image'       => 'assets/frontend/images/products/psyllium-meal.png',
        ],
        [
            'id'          => 9,
            'name'        => 'Psyllium Flour',
            'slug'        => 'psyllium-flour',
            'description' => 'Fine psyllium flour for bakery and gluten-free formulations',
            'categories'  => ['flour', 'powders'],
            'image'       => 'assets/frontend/images/products/psyllium-flour.png',
        ],
    ],
